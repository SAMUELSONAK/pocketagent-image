...
PYTHON_FIX
    ...
    "$INSTALL_DIR/bin/pocketagent" start
    ...
    echo "   To disable auto-start: pocketagent disable"
    echo ""
    echo "📋 Next Steps:"
    echo ""
    ...
    echo ""
    echo "2. Complete onboarding (add API keys)"
    echo ""
    echo "3. Reload your shell to use 'pocketagent' command:"
